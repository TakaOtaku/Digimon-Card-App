...
wikiPageLinks = [
    ...
    {'name': 'ADVANCED DECK SET BEELZEMON [ST-14]',
    ...
    {'name': 'ADVANCED DECK SET DOUBLE TYPHOON [ST-17]',
...
NoteDictionary = {
    ...
    'ST-14: Advanced Deck Set Beelzemon': 'ADVANCED DECK SET BEELZEMON [ST-14]',
    ...
    'ST-17: Advanced Deck Set Double Typhoon': 'ADVANCED DECK SET DOUBLE TYPHOON [ST-17]',
...
replacements = [
    ...
    '(Place the top 2 cards of your deck as your top security 2 cards.)',
    '(Place the top 3 cards of your deck as your top security 3 cards.)',
    ...
    '(When this card in your hand would be digivolved into, by suspending 1 of your other Digimon, reduce the cost by 1.)',
    '(When this card in your hand would be digivolved into, by suspending 1 of your other Digimon, reduce the cost by 2.)',
    '(When this card in your hand would be digivolved into, by suspending 1 of your other Digimon, reduce the cost by 3.)',
    ...
    '(When this Digimon would be deleted, by trashing any 2 of its digivolution cards, it isn\'t deleted.)',
    ...
    '(When an opponent\'s effect would delete any of your other specified Digimon, by deleting this Digimon, 1 of those Digimon isn\'t deleted.)',
