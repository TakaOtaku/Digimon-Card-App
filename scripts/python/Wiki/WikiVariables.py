...
wikiPageLinks = [
    ...
    {'name': '▹BOOSTER ELEMENTAL SUCCESSOR [BT18]',
      ...
      {'name': '▹BOOSTER XROS ENCOUNTER [BT19]',
        'url': 'https://digimoncardgame.fandom.com/wiki/BT-19:_Booster_Xros_Encounter'},
...
NoteDictionary = {
    ...
    'BT-19: Booster Xros Encounter': '▹BOOSTER XRO ENCOUNTER [BT19]',
