...
#    {'name': 'ADVANCED DECK BEELZEMON [ST14]',
...
NoteDictionary = {
    ...
    'ST-14: Advanced Deck Set Beelzemon': 'ADVANCED DECK BEELZEMON [ST14]',
...
replacements = [
    ...
    '(When one of your other Red/Black Digimon would be deleted by an opponent\'s effect, you may delete this Digimon to prevent that deletion)',
