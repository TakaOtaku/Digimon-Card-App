...
ruling = '/Rulings'
wikiPageLinks = [
    #{'name': '▹RELEASE SPECIAL BOOSTER 1.0 [BT1-BT3]', 'url': 'https://digimoncardgame.fandom.com/wiki/BT01-03:_Release_Special_Booster_Ver.1.0'},
    {'name': '▹RELEASE SPECIAL BOOSTER 1.5 [BT1-BT3]', 'url': 'https://digimoncardgame.fandom.com/wiki/BT01-03:_Release_Special_Booster_Ver.1.5'},
    #{'name': '▹BOOSTER GREAT LEGEND [BT4]', 'url': 'https://digimoncardgame.fandom.com/wiki/BT-04:_Booster_Great_Legend'},
    #{'name': '▹BOOSTER BATTLE OF OMNI [BT5]', 'url': 'https://digimoncardgame.fandom.com/wiki/BT-05:_Booster_Battle_Of_Omni'},
    #{'name': '▹BOOSTER DOUBLE DIAMOND [BT6]', 'url': 'https://digimoncardgame.fandom.com/wiki/BT-06:_Booster_Double_Diamond'},
    #{'name': '▹BOOSTER NEXT ADVENTURE [BT7]', 'url': 'https://digimoncardgame.fandom.com/wiki/BT-07:_Booster_Next_Adventure'},
    #{'name': '▹BOOSTER NEW AWAKENING [BT8]', 'url': 'https://digimoncardgame.fandom.com/wiki/BT-08:_Booster_New_Awakening'},
    #{'name': '▹BOOSTER X RECORD [BT9]', 'url': 'https://digimoncardgame.fandom.com/wiki/BT-09:_Booster_X_Record'},
    #{'name': '▹BOOSTER XROS ENCOUNTER [BT10]', 'url': 'https://digimoncardgame.fandom.com/wiki/BT-10:_Booster_Xros_Encounter'},
    #{'name': '▹BOOSTER DIMENSIONAL PHASE [BT11]', 'url': 'https://digimoncardgame.fandom.com/wiki/BT-11:_Booster_Dimensional_Phase'},
    #{'name': '▹BOOSTER ACROSS TIME [BT12]', 'url': 'https://digimoncardgame.fandom.com/wiki/BT-12:_Booster_Across_Time'},
    #{'name': '▹BOOSTER VERSUS ROYAL KNIGHT [BT13]', 'url': 'https://digimoncardgame.fandom.com/wiki/BT-13:_Booster_Versus_Royal_Knights'},
    #{'name': '▹BOOSTER BLAST ACE [BT14]', 'url': 'https://digimoncardgame.fandom.com/wiki/BT-14:_Booster_Blast_Ace'},
    #
    #{'name': '▹THEME BOOSTER CLASSIC COLLECTION [EX1]', 'url': 'https://digimoncardgame.fandom.com/wiki/EX-01:_Theme_Booster_Classic_Collection'},
    #{'name': '▹THEME BOOSTER DIGITAL HAZARD [EX2]', 'url': 'https://digimoncardgame.fandom.com/wiki/EX-02:_Theme_Booster_Digital_Hazard'},
    #{'name': '▹THEME BOOSTER DRAGONIC ROAR [EX3]', 'url': 'https://digimoncardgame.fandom.com/wiki/EX-03:_Theme_Booster_Draconic_Roar'},
    #{'name': '▹THEME BOOSTER ALTERNATIVE BEING [EX4]', 'url': 'https://digimoncardgame.fandom.com/wiki/EX-04:_Theme_Booster_Alternative_Being'},
    #{'name': '▹THEME BOOSTER ANIMAL COLOSSEUM [EX5]', 'url': 'https://digimoncardgame.fandom.com/wiki/EX-05:_Theme_Booster_Animal_Colosseum'},
    #
    #{'name': 'BOOSTER RESURGENCE BOOSTER [RB1]', 'url': 'https://digimoncardgame.fandom.com/wiki/RB-01:_Resurgence_Booster'},
    #
    #{'name': 'STARTER DECK GAIA RED [ST1]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-1:_Starter_Deck_Gaia_Red'},
    #{'name': 'STARTER DECK COCYTUS BLUE [ST2]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-2:_Starter_Deck_Cocytus_Blue'},
    #{'name': 'STARTER DECK HEAVEN\'S Yellow[ST3]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-3:_Starter_Deck_Heaven%27s_Yellow'},
    #{'name': 'STARTER DECK GIGA GREEN [ST4]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-4:_Starter_Deck_Giga_Green'},
    #{'name': 'STARTER DECK MACHINE BLACK [ST5]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-5:_Starter_Deck_Machine_Black'},
    #{'name': 'STARTER DECK VENOMOUS VIOLET [ST6]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-6:_Starter_Deck_Venomous_Violet'},
    #{'name': 'STARTER DECK GALLANTMON [ST7]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-7:_Starter_Deck_Gallantmon'},
    #{'name': 'STARTER DECK ULLFORCEVEEDRAMON [ST8]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-8:_Starter_Deck_UlforceVeedramon'},
    #{'name': 'STARTER DECK ULTIMATE ANCIENT DRAGON [ST9]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-9:_Starter_Deck_Ultimate_Ancient_Dragon'},
    #{'name': 'STARTER DECK PARALLEL WORLD TACTICIAN [ST10]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-10:_Starter_Deck_Parallel_World_Tactician'},
    #{'name': 'STARTER DECK JESMON [ST12]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-12:_Starter_Deck_Jesmon'},
    #{'name': 'STARTER DECK RAGNALOARDMON[ST13]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-13:_Starter_Deck_RagnaLoardmon'},
    #{'name': 'ADVANCE DECK BEELZEMON [ST14]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-14:_Advanced_Deck_Set_Beelzemon'},
    #{'name': 'STARTER DECK DRAGON OF COURAGE [ST15]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-15:_Starter_Deck_Dragon_of_Courage'},
    #{'name': 'STARTER DECK WOLF OF FRIENDSHIP [ST16]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-16:_Starter_Deck_Wolf_of_Friendship'},
    #{'name': 'STARTER DECK DOUBLE TYPHOON [ST17]', 'url': 'https://digimoncardgame.fandom.com/wiki/ST-17:_Advanced_Deck_Set_Double_Typhoon'},
]
...
#TODO Add Illustrator and AAs of Japanese Cards seperatly
...
def getIllustratorsInfo(html, digimoncard):
    ...
    for row in rows:
        ...
        if illustratorCount == 1:
            ...
            digimoncard.AAs.append({'id': '_P' + str(illustratorCount-1), 'illustrator': cells[0].text, 'note': cells[1].text})
        illustratorCount += 1
...
def setImageAndDownload(digimoncard, url):
    ...
    digimoncard.cardImage = 'assets/images/cards/eng/' + digimoncard.cardImage + digimoncard.id + ".webp"
    ...
    if (image is not None):
        ...
        # urllib.request.urlretrieve(imageSrc, 'cardImages/' + digimoncard.cardNumber + ".webp")
    return digimoncard
...
for link in cardLinks:
    ...
    print('[' + str(count) + '/' + str(cardCount) + ']' + currentDigimon.id + ' - ' + currentDigimon.name.english)
    cards.append(currentDigimon)

# Add correct to each Card
for card in cards:
...
for link in cardLinks:
    ...
    if len(questions) == 0:
        print('Rulings for: ' + id + ' - Found ' + str(len(questions)) + ' Rulings')
        continue
    ...
    for question in questions:
        ...
        rulings[id].append({'question': questionText, 'answer': answerText})
        questionCount += 1
...
replace_string_in_json('(This Digimon can attack the turn it comes into play)', '')
replace_string_in_json('(At blocker timing, by suspending this Digimon, it becomes the attack target)', '')
replace_string_in_json('(Trash this card in your battle area to activate the effect below. You can\'t activate this effect the turn this card enters play.)', '')
