export const replacements: Array<[RegExp, string]> = [
  ...
  [/＜Blast DNA Digivolve ([WarGreymon] + [MetalGarurumon])＞/g, 'blast_dna_digivolve_wargreymon_metalgarurumonn'],
  [/＜BBlast DNA Digivolve ([Durandamon] + [BryweLudramon])＞/g, 'blast_dna_digivolve_durandamon_bryweLudramon'],
  [/＜Blitz＞/g, 'blitz'],
  [/＜Blocker＞/g, 'blocker'],
