              ...
              <div class="px-6 py-5 lg:px-8">
                <div class="grid gap-6 md:grid-cols-3 lg:grid-cols-5">
                  ...
                  <div class="surface-ground text-[#e2e4e6]">
                    ...
                    >
                    <a
                      (click)="router.navigateByUrl('/deckbuilder'); this.megamenu = false"
                      aria-current="true"
                      class="block w-full cursor-pointer border-b border-gray-200 px-6 py-2 transition duration-150 ease-in-out hover:text-[#64B5F6] hover:backdrop-brightness-150">
                    ...
                    <a
                      (click)="router.navigateByUrl('/collection'); this.megamenu = false"
                      aria-current="true"
                      class="block w-full cursor-pointer border-b border-gray-200 px-6 py-2 transition duration-150 ease-in-out hover:text-[#64B5F6] hover:backdrop-brightness-150">
                    ...
                    >
                    <a
                      (click)="router.navigateByUrl('/decks'); this.megamenu = false"
                      aria-current="true"
                      class="block w-full cursor-pointer border-b border-gray-200 px-6 py-2 transition duration-150 ease-in-out hover:text-[#64B5F6] hover:backdrop-brightness-150">
                    ...
                    >
                    <a
                      (click)="router.navigateByUrl('/community'); this.megamenu = false"
                      aria-current="true"
                      class="block w-full cursor-pointer border-b border-gray-200 px-6 py-2 transition duration-150 ease-in-out hover:text-[#64B5F6] hover:backdrop-brightness-150">
                      <fa-icon [icon]="faCommunity" class="mr-2 w-5"></fa-icon>
                      Community</a
                    >
                    <a
                      (click)="router.navigateByUrl('/products'); this.megamenu = false"
                      aria-current="true"
                  ...
                  <div class="surface-ground text-[#e2e4e6]">
                    ...
                    <a
                      ...
                      aria-current="true"
                      class="block w-full cursor-pointer border-b border-gray-200 px-6 py-2 transition duration-150 ease-in-out hover:text-[#64B5F6] hover:backdrop-brightness-150"
                      ><i class="fa-solid fa-bug mr-1"></i>Feature/Bug Request</a
                    >
                    <a
                      ...
                      aria-current="true"
                      class="block w-full cursor-pointer border-b border-gray-200 px-6 py-2 transition duration-150 ease-in-out hover:text-[#64B5F6] hover:backdrop-brightness-150"
                      ><i class="fa-brands fa-cc-paypal mr-1"></i>Help the Site!</a
                    >
                  </div>
                  <div class="hidden lg:block"></div>
                </div>
