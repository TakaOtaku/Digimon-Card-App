...
@Component({
  ...
  template: `
    <nav
      ...
      <a
        class="absolute left-4 top-0 z-[5000] flex flex-row"
        (click)="refresh(link)">
        <img
          alt="Logo"
    ...
    <p-dialog
      ...
      <div class="flex w-full flex-col">
        <span class="mt-5 w-full text-center font-bold text-[#e2e4e6]"
          ...
          releases and tests the website completely so I don't have to worry to
          much!</span
        >
