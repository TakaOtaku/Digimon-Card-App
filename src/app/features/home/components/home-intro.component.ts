...
@Component({
  ...
  template: `
    <h1 class="text-shadow mt-6 text-4xl font-black text-[#e2e4e6] underline xl:mt-2">Welcome to Digimoncard.app!</h1>
    ...
    <a class="mx-auto my-2" href="https://www.paypal.com/donate/?hosted_button_id=WLM58Q785D4H4" target="_blank">
